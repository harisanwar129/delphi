...
type
  TDM = class(TDataModule)
    ...
    Q_Jumlah_Stock: TADOQuery;
    Q_Jumlah_Beli: TADOQuery;
    QDSJumlah_Stock: TDataSource;
    QJumlah_Beli: TDataSource;
    Q__jumlah_Jual: TADOQuery;
    Q_Jumlah_Jual: TDataSource;
    Q__jumlah_JualsumHarga_Jual: TFloatField;
